...
# LICENSE gehört ins Paket: der Über-Dialog zeigt die Datei an, und eine Lizenz,
# die nur beim Entwickler auf der Platte liegt, nützt dem Empfänger nichts.
$Inhalt  = @('D2RCharBackupManager.ps1', 'Start D2R Char Backup Manager.cmd',
             'ANLEITUNG.md', 'INSTRUCTIONS.md', 'LICENSE')
