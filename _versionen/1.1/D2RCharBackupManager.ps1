...
function Update-All {
    ...
    # geparkt hat, blendet sie über die Checkbox aus; der Haken wird bewusst
    # nicht gemerkt und steht nach jedem Start wieder auf "anzeigen".
...
$ChkHidePark.Add_Click({ Update-All })
